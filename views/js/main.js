...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // store pizza elements in randomPizzas so as to not query the DOM on every pass
...
function updatePositions() {
  ...
  var scrollTopCache = document.body.scrollTop;
...
// determine number of background pizzas based upon height of screen and number of columns
  pizzas = screenHeight / s * cols;
